...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('Chatbot initialization - Config check:', {
      ...
      // Get Groq API key from config with proper environment variables
    const GROQ_API_KEY = 
...
`;
    ...
    const resultsContainer = document.getElementById('results-container');
      // TomTom API credentials from environment variables
    const tomtomAPIKey = 
    ...
    // Serper.dev API credentials from environment variables
    const serperAPIKey = 
